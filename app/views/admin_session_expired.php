<?php
/*
 * PageLink - Vista: Sesion expirada.
 */
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .box { background: #1a1a1a; padding: 40px; border-radius: 14px; border: 1px solid #2a2a2a; box-shadow: 0 4px 20px rgba(0,0,0,0.3); width: 100%; max-width: 360px; text-align: center; }
        ...
        a { display: block; width: 100%; padding: 12px; background: #c47a8a; color: #fff; border: none; border-radius: 8px; font-size: 1rem; font-weight: 600; cursor: pointer; text-decoration: none; transition: background 0.15s; }
...
<body>
    <div class="box">
        ...
        <a href="<?= base_path() ?>admin/login">Iniciar sesion</a>
    </div>
</body>
</html>
